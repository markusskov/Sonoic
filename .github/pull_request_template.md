...
- [ ] `python3 scripts/agent_harness_check.py` passes when docs, scripts, project structure, or harness files changed
...
- [ ] Docs were updated if setup, behavior, architecture, or verification changed
